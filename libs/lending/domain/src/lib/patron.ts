...
import { MaximumNumberOnHoldsReached } from "../events/maximum-number-on-holds-reached";
...
export class Patron {
  constructor(
    ...
    readonly patronInformation: PatronInformation,
  ) {}
      ...
      if (this.patronHolds.maximumHoldsAfterHoldingNextBook()) {
        return right(
          BookPlacedOnHoldEvents.events(
            ...
            new MaximumNumberOnHoldsReached(),
          ),
        );
      }
